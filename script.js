    ...
    this.init = function (ctrl) {
      $('.art-lightbox').mouseup({ _ctrl: ctrl }, function (e) {
        ...
        if (imgContainer.length === 0) {
          imgContainer = $('<div class="art-lightbox-wrapper">')
  ...
  var ThemeSlider = function (element, settings) {
    ...
    if (this.settings.hover) {
      ...
      element
        ...
        .add(element.siblings('.art-shapes'))
        .hover(
          function () {
...
resizeData['object486920617'] = {
  responsive: [
    { left: 0.03, top: 0.42, visible: true },
    { left: 0.03, top: 0.42, visible: true },
    { left: 0.03, top: 0.42, visible: true },
    { left: 0.03, top: 0.42, visible: true },
    { left: 0.03, top: 0.42, visible: true }
...
var headerObjectResizer = {
  ...
  resize: (function ($) {
    ...
    return function () {
      ...
      // move html shapes
      var headerQuery =
        'header.art-header .art-shapes>*, header.art-header .art-textblock, header.art-header>.art-headline, header.art-header>.art-slogan, header.art-header>.art-positioncontrol, header.art-header>.art-logo'
      var pageSliderQuery = '.art-pageslider .art-slide-item>*'
      if (headerObjectResizer.isPreview) {
        headerQuery = 'header .art-slider'
        pageSliderQuery =
          '.art-pageslider .art-slider, .art-pageslider .art-textblock'
      }
